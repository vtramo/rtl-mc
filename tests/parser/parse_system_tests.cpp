...
TEST_CASE("Correctly report syntax errors when parsing PolyhedralSystem", "[bad]")
{
    SECTION("Non-integer coefficient [TEST 1]")
    {
        ...
        REQUIRE(polyhedralSystemParsingResult.lexicalErrorCount() == 1);
        REQUIRE(polyhedralSystemParsingResult.unknownErrorCount() == 0);
        REQUIRE(polyhedralSystemParsingResult.lexicalErrors().size() == 1);
        REQUIRE(polyhedralSystemParsingResult.syntaxErrors().size() == 1);
        REQUIRE(polyhedralSystemParsingResult.unknownErrors().empty());

        const PolyhedralSystemParserError nonIntegerError { polyhedralSystemParsingResult.lexicalErrors()[0] };
    ...
    SECTION("Non-integer coefficient [TEST 3]")
    {
        ...
        REQUIRE(!polyhedralSystemParsingResult.ok());
        REQUIRE(polyhedralSystemParsingResult.errorCount() == 3);
        REQUIRE(polyhedralSystemParsingResult.lexicalErrorCount() == 2);
        REQUIRE(polyhedralSystemParsingResult.syntaxErrorCount() == 1);
        REQUIRE(polyhedralSystemParsingResult.lexicalErrors().size() == 2);
        REQUIRE(polyhedralSystemParsingResult.syntaxErrors().size() == 1);
        REQUIRE(polyhedralSystemParsingResult.unknownErrors().empty());

        const PolyhedralSystemParserError firstNonIntegerError { polyhedralSystemParsingResult.lexicalErrors()[0] };
    ...
    SECTION("Invalid variable identifier")
    {
        ...
        const PolyhedralSystemParserError invalidVariableIdError { polyhedralSystemParsingResult.syntaxErrors()[0] };
    ...
    SECTION("Missing INV")
    {
        ...
        const PolyhedralSystemParserError firstNonIntegerError { polyhedralSystemParsingResult.syntaxErrors()[0] };
        REQUIRE(firstNonIntegerError.line() == 4);
