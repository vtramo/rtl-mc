...
TEST_CASE("GAP Test Cases (DenotRecursiveMemoization)")
{
    ...
    SECTION("GAP k=1")
    {
        ...
        DenotRecursiveMemoization denot { polyhedralSystem, backwardNfa };
...
TEST_CASE("NO GAP Test Cases (DenotRecursiveMemoization)")
{
    PolyhedralSystemConstSharedPtr polyhedralSystem {
        std::make_shared<PolyhedralSystem>(
            std::move(
