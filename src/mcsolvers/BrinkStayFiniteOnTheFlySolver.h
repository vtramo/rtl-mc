...
public:
      ...
      , m_brinkSemantics { brinkSemantics }
    {
        ...
        m_staySolver = std::make_shared<StayFiniteOnTheFlySolver>(stayPolyhedralSystem, m_rtlFormula, m_translationOptimizationFlags, m_universalDenotation, m_concurrent);
        m_brinkSolver = std::make_shared<BrinkFiniteOnTheFlySolver>(brinkPolyhedralSystem, m_rtlFormula, m_translationOptimizationFlags, m_universalDenotation, m_concurrent);
    }
    ...
    SolverResult run() override
    {
        ...
        StayFiniteOnTheFlySolver staySolver { stayPolyhedralSystem, m_rtlFormula, m_translationOptimizationFlags, m_universalDenotation, m_concurrent, m_discretiseRtlfDirectToLtl, m_collectPaths };
        BrinkFiniteOnTheFlySolver brinkSolver { brinkPolyhedralSystem, m_rtlFormula, m_translationOptimizationFlags, m_universalDenotation, m_concurrent, m_brinkSemantics, m_discretiseRtlfDirectToLtl, m_collectPaths };
